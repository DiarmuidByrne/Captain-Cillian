...
public class EMPPuzzleController : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.Space();
        SerializedProperty sprop = serializedObject.FindProperty("OnWrongPiecesOpened");
        EditorGUILayout.PropertyField(sprop);

        sprop = serializedObject.FindProperty("OnMatchedPiecesOpened");
        EditorGUILayout.PropertyField(sprop);

        sprop = serializedObject.FindProperty("OnAllPiecesOpened");
        EditorGUILayout.PropertyField(sprop);
